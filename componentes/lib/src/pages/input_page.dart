...
class _InputPageState extends State<InputPage> {
  ...
  List<String> _poderes = ['Volar','Rayox X', 'Super Aliento','Super Fuerza'];
  ...
  Widget _crearEmail() {
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        counter: Text("letras " + _email.length.toString()),
        hintText: "Email",
        labelText: "Email",
